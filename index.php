...
if (isset($_POST['submit'])) {
 ...
 move_uploaded_file($_FILES["image"]["tmp_name"],$bannerpath);
 	$obj->Saveproduct($productname,$color,$size,$discription,$bannername,$categoryname);
					...
					<div class="col-xl-4 col-lg-5">
						<div class="user-panel">
							<div class="up-item">
								...
								<a href="http://localhost/shopping%20stor/blank.php"><?php
								if ($_SESSION['login']) {
									echo $_SESSION['login'];	
								}else{
									echo "Create Account";
			...
			<div class="product-slider owl-carousel">
				...
				<div class="product-item">		
					<div class="pi-pic">			 
					 	...
					 	<a  href="#"><img src="banners/<?php echo $Path['image'];?>"width=""> </a>
						<div class="pi-links">
							<a href="singalproduct.php?editid=<?php echo $Path['product_id' ];?>" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
						</div>
							 
					</div>
					<div class="pi-text">
						<h6>$<?php echo $Path['price'];?></h6>
						<p><b><i><?php echo $Path['productname'];?></i> </b></p>
					</div>
				</div>
				<?php endforeach;?> 
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6">
					...
					<div class="product-item">
						...
						<div class="pi-text">
							<h6>$<?php echo $path['price'];?></h6>
							<p><b><i><?php echo $path['productname'];?> </b></i> </p>
						</div>
