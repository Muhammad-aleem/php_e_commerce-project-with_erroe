...
if (isset($_POST['submit'])) {	
    ...
    $obj->SavecartData($_GET['editid'],$quantity,$ipaddress);

}

// if(isset($_GET['editid']))
// {
// 	$singledata = $obj->getSingleproductData($_GET['editid']);

// 	$result = $obj->getSingleproductData($_GET['editid']);	
// 	// var_dump($result);
// 	// die();
// }
...
if(isset($_GET['editid']))
{
	$singlestudentdata = $obj->getSingleproductData($_GET['editid']);
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<!-- <input type="file" name="image" class="product-big-img" > -->
					<img class="product-big-img" src="banners/<?php echo $singlestudentdata['image'];?>"width="">
				...
				<div class="col-lg-6 product-details">
					<h2 class="p-title"><?php echo $singlestudentdata['productname'];?></h2>
					<h3 class="p-price">$<?php echo  $singlestudentdata['price'];?></h3>
					...
					<button class="site-btn" type="submit" name="submit">SHOP NOW</button>
						...
						<div class="panel">
							...
							<div id="collapse1" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
								<div class="panel-body">
									<p><?php echo $singlestudentdata['discription']; ?></p>
								</div>
							</div>
						</div>
						<div class="panel">
